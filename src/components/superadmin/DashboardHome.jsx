...
export default function DashboardHome({ setActiveTab }) {
  ...
  const loadAdvancedDashboardData = async () => {
    ...
    try {
      ...
      // Get current user (may be null in testing mode for unauthenticated SuperAdmin access)
      // This helps to ensure that even if authentication fails, the data fetching process can continue.
